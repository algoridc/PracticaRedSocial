...
<div class="row"  style="background-color:lightgray"> 
 ...
 <div class="row" name="mesaggesPanel"> 
   <div class="col-md-3" style="background-color:lightblue">información de usuario</div> 
   <div class="col-md-6">mensajes de los contactos</div> 
   <div class="col-md-3" style="background-color:lightgray">otras opciones</div> 
 </div> 
